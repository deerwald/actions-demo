...
LABEL com.github.actions.name="Some Image" \
      ...
      org.opencontainers.image.url="https://github.com/deerwald/actions-demo" \
      org.opencontainers.image.source="https://github.com/deerwald/actions-demo" \
      org.opencontainers.image.documentation="https://github.com/deerwald/actions-demo" \
